...
[[bulk_extractor]{.underline}](https://forensicswiki.xyz/wiki/index.php?title=Bulk_extractor),
...
1.  The first step is to create a working directory to hold the
    ...
    the \"Home\" folder on your desktop. Then right click anywhere on
    the white background (i.e., not on an existing folder), and click
...
> for.To begin your analysis, first select the type of media you want to
> scan, which in our case is a disk image, so we\'ll select the \"image
> file\" radial button (see Figure 2)
...
> for you.
>
> 7\. Optional: If desired, you may check or uncheck the scanner options
> from the list on the right (see Figure 3). You can refine your
> analysis of the disk image by choosing which \"scanners\"
...
> may be useful to you, and where they output their results can be found
> here.\
> \
> **Figure 3**: Scanner options in the Bulk Extractor Viewer.\
> ![](./media/image2.png){width="6.5in" height="6.402777777777778in"}
>
...
> ![](./media/image3.png){width="5.610953630796151in"
> height="7.921875546806649in"}
>
> 8\. Finally, click the \"Start bulk_extractor\" button at the bottom
> of the screen to begin the scan.

9.  Once bulk_extractor has finished analyzing the disk image, you can
    view the output by selecting the new report in the \"Reports\"
    window of Bulk Extractor Viewer. The report will be named after the
    Features Output Directory you created in step 6, so in our example
    we will see \"be_report\" (see Figure 5). Once you select the
    report, you will see a listing of each scanner for which a feature
    was found by bulk_extractor. Selecting a specific scanner or its
