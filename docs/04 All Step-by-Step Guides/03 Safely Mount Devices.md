...
programs provided by [<u>The Sleuth Kit</u>](http://www.sleuthkit.org/),
...
<img src="./media/image4.png" style="width:6.5in;height:5.125in" />
...
<img src="./media/image1.png" style="width:6.5in;height:5.13889in" />
...
<img src="./media/image6.png" style="width:6.5in;height:5.11111in" />
...
- Looking at the *label* column, I recognized the USB drive's "KINGSTON"
  label;

- Looking at the *fs type* column, I double-checked that the listed file
  system type (vfat; learn more about file system types
  [<u>here</u>](http://technet.microsoft.com/en-us/library/cc750354.aspx))
...
<img src="./media/image5.png" style="width:6.5in;height:5.09722in" />
...
<img src="./media/image2.png" style="width:6.5in;height:5.11111in" />
...
<img src="./media/image3.png" style="width:6.5in;height:5.125in" />
